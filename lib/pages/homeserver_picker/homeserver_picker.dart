...
import '../../slides/home.dart';
import '../../slides/tech.dart';
import '../../slides/vax.dart';
import 'homeserver_bottom_sheet.dart';
import 'homeserver_picker_view.dart';

class FHomeserverPicker extends StatefulWidget {
  const FHomeserverPicker({Key? key}) : super(key: key);

  @override
  FHomeserverPickerController createState() => FHomeserverPickerController();
}

class FHomeserverPickerController extends State<FHomeserverPicker> {
  ...
  void showServerInfo(HomeserverBenchmarkResult server) => showModalBottomSheet(
        context: context,
        builder: (_) => FHomeserverBottomSheet(
          homeserver: server,
        ),
      );
